create table public.farmer_offers (
    ...
    remaining_price_lock_credit numeric null,
    total_price_lock_credit numeric null,
    update_count smallint not null default '5'::smallint,
    ...
    constraint farmer_offers_fpls_id_fkey foreign KEY (fpls_id) references farmer_price_lock_subscriptions (fpls_id),
    constraint farmer_offers_listing_id_fkey foreign KEY (listing_id) references produce_variety_listing (listing_id) on update CASCADE on delete CASCADE,
