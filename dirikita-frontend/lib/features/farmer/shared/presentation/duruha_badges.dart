...
class BadgeShowcase extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<DuruhaBadge> userBadges = [
      DuruhaBadge(
        category: BadgeCategory.years,
        tier: DuruhaBadgeTier.silver,
        progress: 1.0,
      ),
      DuruhaBadge(
        category: BadgeCategory.earnings,
        tier: DuruhaBadgeTier.gold,
        progress: 0.75,
      ),
      DuruhaBadge(
        category: BadgeCategory.transactions,
        tier: DuruhaBadgeTier.platinum,
        progress: 0.4,
      ),
    ];
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // 2. Display them in a Grid or List
            Expanded(
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return BadgeCard(badge: badge, isUnlocked: badge.isUnlocked);
                },
              ),
            ),
          ],
